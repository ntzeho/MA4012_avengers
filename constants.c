...
const short DEFAULT_MOTOR_HOME_DRIVING_SPEED = 40;

const short START_MOVE_FIELD_DISTANCE = 150;
const short END_MOVE_FIELD_DISTANCE = 120;

const short START_MOVE_FIELD_TIME = 3000;
...
const short ROBOT_BALL_SHORT_DISTANCE_THRESHOLD = 50;
const short ROBOT_SENSOR_DIFF_THRESHOLD = 5;

const short ROBOT_STATE_CORRECT_VALUE = 2;
const short FRONT_DIST_CORRECT_VALUE = 5;
