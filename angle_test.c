...
short time_taken_to_rotate_45_degrees;
short time_taken_to_rotate_90_degrees;
short time_taken_to_rotate_135_degrees;
short time_taken_to_rotate_180_degrees;
char start_position;
short ball_count = 0;
...
task action() {
	if (robot_orientation != NORTH) {turn(1,30);}
		...
		clearTimer(T1);
		turn(1,30);
		while (robot_orientation != NORTHEAST) {}
		time_taken_to_rotate_45_degrees = time1[T1];
		sleep(100);
		stop_movement();
	}
